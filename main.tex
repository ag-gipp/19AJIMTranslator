...
We integrated the defined translation patterns from our library also into these lexicon files. Thus the tagger also tags a node in the parse tree by its translation patterns. \Cref{tab:sine-lex-example} gives an example of an entry of the lexicon file.

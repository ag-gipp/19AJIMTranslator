...
{\bf [HSC: The supposed definition is: ``We consider a translation as {\it appropriate}, when a numerical evaluation returns the 
same values in both concepts up to a numerical precision $|\epsilon|<<1$, for all possible 
points in the domain of the functions.'' We also need a definition for innapropriate translation.]}
We call a translation such as

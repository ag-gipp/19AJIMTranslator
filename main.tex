...
\begin{tabular}{lc}
\hline
Displayed As & \rule{0pt}{0.9\normalbaselineskip} $\cos^n(x)^m$ \\
Semantic \LaTeX & \verb|\cos^n@{x}^m| \\
Translated \Maple{} Expression & \verb|((cos(x))^(n))^m|\\
\hline
\end{tabular}
